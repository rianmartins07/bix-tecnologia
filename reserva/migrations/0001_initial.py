    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cancelada', models.BooleanField(default=False, help_text='usuario cancelou reserva')),
                ('data_cancelamento', models.DateField(default=None, null=True)),
                ('reserva_fechada', models.BooleanField(default=False, help_text='field para identificar quando mandou email ou cancelou ou terminou checkout')),
